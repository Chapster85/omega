...
In order to support loading of multiple wallets in omega-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is omega.cpp.
...
Changes to omega.cpp
----------------------
omega.cpp is the entry point into omega-qt, and as such, will require some minor modifications to provide hooks for

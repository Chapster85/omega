...
RESOURCES += src/qt/omega.qrc src/qt/omega_locale.qrc

TRANSLATIONS += src/qt/locale/omega_bg.ts \
                src/qt/locale/omega_de.ts \
                src/qt/locale/omega_en.ts \
                src/qt/locale/omega_es.ts \
                src/qt/locale/omega_fi.ts \
                src/qt/locale/omega_fr.ts \
                src/qt/locale/omega_it.ts \
                src/qt/locale/omega_ja.ts \
                src/qt/locale/omega_pl.ts \
                src/qt/locale/omega_pt.ts \
                src/qt/locale/omega_ru.ts \
                src/qt/locale/omega_sk.ts \
                src/qt/locale/omega_sv.ts \
                src/qt/locale/omega_vi.ts \
                src/qt/locale/omega_zh_CN.ts \
                src/qt/locale/omega_zh_TW.ts

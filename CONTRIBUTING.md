Contributing to Omega Network Core
============================

The Omega Network Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Omega Network Core project, and is not to be
confused with overall Omega Network Network Protocol consensus changes.

Whether a pull request is merged into Omega Network Core rests with the project merge
...
Patches that change Omega Network consensus rules are considerably more involved than
...
Where a patch set proposes to change the Omega Network consensus, it must have been
...
The project leader is the release manager for each Omega Network Core release.

...
// Copyright (c) 2015-2017 The Omega Network Core developers
 ...
 * Omega Network system. There are three: the main network on which people trade goods
...
public:
    ...
    int SubsidySlowStartInterval() const { return nSubsidySlowStartInterval; }

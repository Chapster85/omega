                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received OMEGA from zOMEGA"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zOMEGA"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zOMEGA));

                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Omega Network Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Omega Network address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and omega: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zOMEGA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Omega Network Core"), this);
    aboutAction->setStatusTip(tr("Show information about Omega Network Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Omega Network"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Omega Network addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Omega Network addresses"));
    ...
    openAction->setStatusTip(tr("Open a Omega Network: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Omega Network Core help message to get a list with possible Omega Network command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Omega Network Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Omega Network network", "", count));
}
...
{
    QString strTitle = tr("Omega Network Core"); // default title

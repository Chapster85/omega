...
/** Utility functions used by the Omega Network Qt UI.
 */
namespace GUIUtil
{
...
// Render Omega Network addresses in monospace font
...
// Parse "omega:" URI into recipient object, return true on successful parsing

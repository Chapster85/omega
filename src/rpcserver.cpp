...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Omega Network server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Omega Network server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"omega", "masternode", &masternode, true, true, false},
        {"omega", "listmasternodes", &listmasternodes, true, true, false},
        {"omega", "getmasternodecount", &getmasternodecount, true, true, false},
        {"omega", "masternodeconnect", &masternodeconnect, true, true, false},
        {"omega", "masternodecurrent", &masternodecurrent, true, true, false},
        {"omega", "masternodedebug", &masternodedebug, true, true, false},
        {"omega", "startmasternode", &startmasternode, true, true, false},
        {"omega", "createmasternodekey", &createmasternodekey, true, true, false},
        {"omega", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"omega", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"omega", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"omega", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"omega", "getmasternodescores", &getmasternodescores, true, true, false},
        {"omega", "mnbudget", &mnbudget, true, true, false},
        {"omega", "preparebudget", &preparebudget, true, true, false},
        {"omega", "submitbudget", &submitbudget, true, true, false},
        {"omega", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"omega", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"omega", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"omega", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"omega", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"omega", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"omega", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"omega", "checkbudgets", &checkbudgets, true, true, false},
        {"omega", "mnsync", &mnsync, true, true, false},
        {"omega", "spork", &spork, true, true, false},
        {"omega", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"omega", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use omegad, or the -server option to omega-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> omega-cli " + methodname + " " + args + "\n";
}
